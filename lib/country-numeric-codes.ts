/**
 * ISO 3166-1 numeric → alpha-2. Only needed to match the world-atlas topojson
 * used by the admin map, which identifies countries by numeric code.
 */
...
export function alpha2FromNumeric(id: string | number): string | null {
  return NUMERIC_TO_ALPHA2[String(id).padStart(3, '0')] ?? null
}
