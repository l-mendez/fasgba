...
export type CountryAccessRow = DbRow<'country_access'>
export type CountryAccessLogRow = DbRow<'country_access_log'>
export type CountryTrafficDailyRow = DbRow<'country_traffic_daily'>
