...
export default function EditarTorneoPage({ params }: PageProps) {
  ...
  if (authLoading || isLoadingTournament) {
    return (
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              {authLoading ? "Verificando autenticación..." : "Cargando torneo..."}
            </p>
          </div>
        </div>
      </div>
  ...
  if (!tournament && !isLoadingTournament && error) {
    return (
      <div className="flex flex-col gap-8 p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-terracotta">Error</h1>
            <p className="text-muted-foreground">No se pudo cargar el torneo</p>
          </div>
        </div>
