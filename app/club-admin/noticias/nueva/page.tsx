...
export default function NuevaNoticiaPage() {
  ...
  // Redirigir si no hay club seleccionado
  if (!selectedClub) {
    return (
      <div className="flex flex-col items-center justify-center p-8 h-[calc(100vh-4rem)]">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Por favor, selecciona un club antes de crear noticias</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex justify-between">
            <Button variant="outline" type="button" asChild>
              <Link href="/club-admin/noticias">Cancelar</Link>
            </Button>
